...
--// msgs
local help_title = "usr_nick_prefix_mod.lua"
local help_usage = "[+!#]nickprefix add <NICK> <PREFIX>  /  [+!#]nickprefix del <NICK>"
local help_desc = "This script adds a prefix to the nick of an user"

local msg_denied = "You are not allowed to use this command."
local msg_god = "You are not allowed to add/change the nick prefix this user."
local msg_isbot = "User is a bot."
local msg_notonline = "User is offline."
local msg_notfound = "No prefix found."
local msg_forbidden = "The prefix includes forbidden characters or whitespaces."
local msg_usage = "Usage: [+!#]nickprefix add <NICK> <PREFIX>  /  [+!#]nickprefix del <NICK>"

local msg_prefix_add = "%s  added the nick prefix from user: %s  to: %s"
local msg_prefix_change = "%s  changed the nick prefix from user: %s  to: %s"
local msg_prefix_remove = "%s  removed the nick prefix from user: %s"

local ucmd_menu_ct2_1 = { "Nick Prefix", "add//change" }
local ucmd_menu_ct2_2 = { "Nick Prefix", "remove" }
local ucmd_prefix = "New nick prefix:"
