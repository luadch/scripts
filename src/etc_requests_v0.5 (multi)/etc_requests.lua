...
local msg_etc_15 = lang.msg_etc_15 or "REQUEST"
local msg_etc_16 = lang.msg_etc_16 or "FILLED"
            ...
            if user_level >= minlevel then
                ...
                for rel, v in pairs( releases_tbl ) do
                    for nick, flag in pairs( v ) do
                        if flag == R then
                            msg = msg .. msg_etc_15 .. "\t" .. rel .. msg_etc_01 .. nick .. "\n"
                        end
                    end
                end
        ...
        filled_show = function()
            ...
            if user_level >= minlevel then
                ...
                for rel, v in pairs( releases_tbl ) do
                    for nick, flag in pairs( v ) do
                        if flag == F then
                            msg = msg .. msg_etc_16 .. "\t" .. rel .. msg_etc_01 .. nick .. "\n"
                        end
                    end
                end
                user:reply( msg_header .. msg .. msg_footer, hub_getbot )
            ...
            if user_level >= minlevel then
                ...
                for rel, v in pairs( releases_tbl ) do
                    for nick, flag in pairs( v ) do
                        ...
                        if flag == F then
                            msg2 = msg2 .. msg_etc_16 .. "\t" .. rel .. msg_etc_01 .. nick .. "\n"
                        end
                    end
                end
