...
hub.setlistener( "onStart", { },
    function( p )
        ...
        if ucmd then
            ...
            ucmd.add({ucmd_menu,"Movies","SD","eintragen"},FreshStuff.Commands.Add,{"Movies_SD","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Movies","SD","anzeigen"},FreshStuff.Commands.Show,{"Movies_SD"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"Movies","DVD","eintragen"},FreshStuff.Commands.Add,{"Movies_DVD","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Movies","DVD","anzeigen"},FreshStuff.Commands.Show,{"Movies_DVD"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"Movies","720p","eintragen"},FreshStuff.Commands.Add,{"Movies_720p","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Movies","720p","anzeigen"},FreshStuff.Commands.Show,{"Movies_720p"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"Movies","1080p","eintragen"},FreshStuff.Commands.Add,{"Movies_1080p","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Movies","1080p","anzeigen"},FreshStuff.Commands.Show,{"Movies_1080p"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"Movies","COMPLETE.BLURAY","eintragen"},FreshStuff.Commands.Add,{"Movies_COMPLETE.BLURAY","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Movies","COMPLETE.BLURAY","anzeigen"},FreshStuff.Commands.Show,{"Movies_COMPLETE.BLURAY"}, { "CT1" },20)

            -----------------------------------------------------------------------------------------
            
            ucmd.add({ucmd_menu,"TV","SD","eintragen"},FreshStuff.Commands.Add,{"TV_SD","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"TV","SD","anzeigen"},FreshStuff.Commands.Show,{"TV_SD"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"TV","DVD","eintragen"},FreshStuff.Commands.Add,{"TV_DVD","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"TV","DVD","anzeigen"},FreshStuff.Commands.Show,{"TV_DVD"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"TV","720p","eintragen"},FreshStuff.Commands.Add,{"TV_720p","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"TV","720p","anzeigen"},FreshStuff.Commands.Show,{"TV_720p"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"TV","1080p","eintragen"},FreshStuff.Commands.Add,{"TV_1080p","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"TV","1080p","anzeigen"},FreshStuff.Commands.Show,{"TV_1080p"}, { "CT1" },20)
            
            ucmd.add({ucmd_menu,"TV","COMPLETE.BLURAY","eintragen"},FreshStuff.Commands.Add,{"TV_COMPLETE.BLURAY","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"TV","COMPLETE.BLURAY","anzeigen"},FreshStuff.Commands.Show,{"TV_COMPLETE.BLURAY"}, { "CT1" },20)
            ...
            ucmd.add({ucmd_menu,"Music","MP3","eintragen"},FreshStuff.Commands.Add,{"Music_MP3","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Music","MP3","anzeigen"},FreshStuff.Commands.Show,{"Music_MP3"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"Music","FLAC","eintragen"},FreshStuff.Commands.Add,{"Music_FLAC","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Music","FLAC","anzeigen"},FreshStuff.Commands.Show,{"Music_FLAC"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"Music","MViD","eintragen"},FreshStuff.Commands.Add,{"Music_MViD","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Music","MViD","anzeigen"},FreshStuff.Commands.Show,{"Music_MViD"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"Music","MDVDR","eintragen"},FreshStuff.Commands.Add,{"Music_MDVDR","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Music","MDVDR","anzeigen"},FreshStuff.Commands.Show,{"Music_MDVDR"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"Music","MBluRay","720p","eintragen"},FreshStuff.Commands.Add,{"Music_MBluRay_720p","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Music","MBluRay","720p","anzeigen"},FreshStuff.Commands.Show,{"Music_MBluRay_720p"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"Music","MBluRay","1080p","eintragen"},FreshStuff.Commands.Add,{"Music_MBluRay_1080p","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Music","MBluRay","1080p","anzeigen"},FreshStuff.Commands.Show,{"Music_MBluRay_1080p"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"Music","MBluRay","COMPLETE.BLURAY","eintragen"},FreshStuff.Commands.Add,{"Music_MBluRay_COMPLETE.BLURAY","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Music","MBluRay","COMPLETE.BLURAY","anzeigen"},FreshStuff.Commands.Show,{"Music_MBluRay_COMPLETE.BLURAY"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"Music","AUDiOBOOKS","eintragen"},FreshStuff.Commands.Add,{"Music_AUDiOBOOKS","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Music","AUDiOBOOKS","anzeigen"},FreshStuff.Commands.Show,{"Music_AUDiOBOOKS"}, { "CT1" },20)
            ...
            ucmd.add({ucmd_menu,"Games","PC","eintragen"},FreshStuff.Commands.Add,{"Spiele_PC","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Games","PC","anzeigen"},FreshStuff.Commands.Show,{"Spiele_PC"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"Games","XBOX","eintragen"},FreshStuff.Commands.Add,{"Spiele_XBOX","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Games","XBOX","anzeigen"},FreshStuff.Commands.Show,{"Spiele_XBOX"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"Games","XBOX360","eintragen"},FreshStuff.Commands.Add,{"Spiele_XBOX360","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Games","XBOX360","anzeigen"},FreshStuff.Commands.Show,{"Spiele_XBOX360"}, { "CT1" },20)
            
            ucmd.add({ucmd_menu,"Games","XBOXONE","eintragen"},FreshStuff.Commands.Add,{"Spiele_XBOXONE","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Games","XBOXONE","anzeigen"},FreshStuff.Commands.Show,{"Spiele_XBOXONE"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"Games","PS2","eintragen"},FreshStuff.Commands.Add,{"Spiele_PS2","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Games","PS2","anzeigen"},FreshStuff.Commands.Show,{"Spiele_PS2"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"Games","PS3","eintragen"},FreshStuff.Commands.Add,{"Spiele_PS3","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Games","PS3","anzeigen"},FreshStuff.Commands.Show,{"Spiele_PS3"}, { "CT1" },20)
            
            ucmd.add({ucmd_menu,"Games","PS4","eintragen"},FreshStuff.Commands.Add,{"Spiele_PS4","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Games","PS4","anzeigen"},FreshStuff.Commands.Show,{"Spiele_PS4"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"Games","PSP","eintragen"},FreshStuff.Commands.Add,{"Spiele_PSP","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Games","PSP","anzeigen"},FreshStuff.Commands.Show,{"Spiele_PSP"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"Games","Wii","eintragen"},FreshStuff.Commands.Add,{"Spiele_Wii","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Games","Wii","anzeigen"},FreshStuff.Commands.Show,{"Spiele_Wii"}, { "CT1" },20)

            ucmd.add({ucmd_menu,"Games","NDS","eintragen"},FreshStuff.Commands.Add,{"Spiele_NDS","%[line:Name:]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Games","NDS","anzeigen"},FreshStuff.Commands.Show,{"Spiele_NDS"}, { "CT1" },20)
            ...
            ucmd.add({ucmd_menu,"Xtra","Show the Top Releaser"},FreshStuff.Commands.TopAdders,{}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Xtra","Search a Release"},FreshStuff.Commands.Search,{"%[line:Was?]"}, { "CT1" },20)
            ucmd.add({ucmd_menu,"Xtra","Delete Release"},FreshStuff.Commands.Delete,{"%[line:ID Nummer(n):]"},  { "CT1" },70)
            ucmd.add({ucmd_menu,"Xtra","Releasedatabase reload"},FreshStuff.Commands.ReLoad,{}, { "CT1" },70)
            ucmd.add({ucmd_menu,"Xtra","Delete old Releases"},FreshStuff.Commands.Prune,{"%[line:Max. Age in Days (Enter=defaults to "..FreshStuff.MaxItemAge.."):]"}, { "CT1" },100)
...
function parsecmds( user, data, env, cmd, bot )
    ...
    if commandtable[ cmd ] then
        if commandtable[ cmd ][ "level" ] ~= 0 then
            ...
            SendTxt( user, env, bot, "This comman is disabled. Please contact the Hubowner." )
        end
    end
end
...
function help( user, data, env )
    ...
    table.sort( hlptbl )
    hlp = hlp .. table.concat( hlptbl, "\n" ) .. "\n\nAlle " .. count .. " You can execute commands in main or in pm, available command prefixes:" ..
    " ! # + - ?\r\n=================================================================================================================================" .. Bot.version
    user:reply( hlp, Bot.name, Bot.name )
end

function FreshStuff.ShowCrap( user, data, env )
    if FreshStuff.Count < 1 then SendTxt( user, env, Bot.name, "There ar no Releases in the database atm." ) return end
    ...
    if cat then
        if FreshStuff.Types[ cat ] then
            if string.find( tune, "$", 1, true ) then
                SendTxt( user, env, Bot.name, "No dollar chars in Releasenames ($)!" )
                return
            end
            if FreshStuff.Count > 0 then
                for i = 1, FreshStuff.Count do
                    ...
                    if title == tune then
                        SendTxt( user, env, Bot.name, "There are an other Release with this name in the category: " .. FreshStuff.Types[ ct ] .. "." )
                        return
                    end
                end
            end
            SendTxt( user, env, Bot.name, tune .. " was added as: " .. cat )
            hub.broadcast( user:nick() .. " added to the category: " .. cat .. "  the following Release: " .. tune, Bot.name )
            FreshStuff.Count = FreshStuff.Count + 1
            FreshStuff.AllStuff[ FreshStuff.Count ] = { cat, user:nick(), os.date( "%m/%d/%Y" ), tune }
            FreshStuff.SaveRel()
            FreshStuff.ReloadRel()
        else
            SendTxt( user, env, Bot.name, "Unkonwn category: " .. cat )
        end
    else
        SendTxt( user, env, Bot.name, "I dont konw what you ar mean :)" )
    end
end
...
function FreshStuff.ShowRel( tab )
    ...
    if tab == FreshStuff.NewestStuff then
        ...
        FreshStuff.MsgNew = "\n" .. "\n===========================================================================================================================================\n" ..
                                    "\t\t\t\t\t                              THE  " .. FreshStuff.MaxNew - 1 .. "  NEWEST RELEASES\n" ..
                                    Msg ..
                                    "\n===========================================================================================================================================\n"
    else
        if FreshStuff.Count == 0 then
            ...
            FreshStuff.MsgHelp = FreshStuff.MsgHelp .. "> to show only the choosen categories"
            for i = 1, FreshStuff.Count do
                if FreshStuff.AllStuff[ i ] then
...
function FreshStuff.ShowRelType( what )
    ...
    if FreshStuff.Count == 0 then
        MsgType = "\n\n" .. " --------- All from: " .. FreshStuff.Types[ what ] ..
                            " -------- \n\n  No " .. string.lower( FreshStuff.Types[ what ] ) ..
                            " im Moment\n\n --------- All from: " .. FreshStuff.Types[ what ] .. " -------- \n\n"
    else
        for i = 1, FreshStuff.Count do
            cat, who, when, title = unpack( FreshStuff.AllStuff[ i ] )
            if cat == what then
                tmp = tmp + 1
                Msg = Msg .. "Nr: " .. i .. "\t ->    " .. title .. "  ->  added by  " .. who .. "  on  [" .. when .. "]\n"
            end
        end
        if tmp == 0 then
            MsgType = "\n\n" .. " --------- All from: " .. FreshStuff.Types[ what ] .. " -------- \n\n  No " .. string.lower( FreshStuff.Types[ what ] ) ..
    ...
    if what then
        ...
        for k = table.getn( tmp ), 1, -1 do
            ...
            if FreshStuff.AllStuff[ n ] then
                SendTxt( user, env, Bot.name, FreshStuff.AllStuff[ n ][ 4 ] .. " was deleted." )
                FreshStuff.AllStuff[ n ] = nil
                cnt = cnt + 1
            else
                SendTxt( user, env, Bot.name, "Release with number " .. wht .. " was deledet from database." )
            end
        end
        if cnt > 0 then
            FreshStuff.SaveRel()
            FreshStuff.ReloadRel()
            SendTxt( user, env, Bot.name, "deleted " .. cnt .. " Release(s), it takes " .. os.clock() - x .. " seconds." )
        end
    else
        SendTxt( user, env, Bot.name, "I dont know what you mean :)" )
    end
end
...
function FreshStuff.ReloadRel( user, data, env )
    ...
    if user then SendTxt( user, env, Bot.name, "Releases reloaded, it takes " .. os.clock() - x .. " seconds." ) end
end
...
function FreshStuff.SearchRel( user, data, env )
    ...
    if what then
        local res, rest = 0, {}
        local msg = "\n---------- you are searching for: \"" .. what .. "\". the results: ----------\n\n"
        ...
        if table.getn( rest ) ~= 0 then
            ...
            msg = msg .. "\nSearch string " .. what .. " was not found in the database."
        end
...
function FreshStuff.AddCatgry( user, data, env )
    ...
    if what1 then
        if string.find( what1, "$", 1, true ) then SendTxt( user, env, Bot.name, " the dollar char ($) is not allowed." ) return 1 end
        if not FreshStuff.Types[ what1 ] then
            FreshStuff.Types[ what1 ] = what2
            FreshStuff.SaveCt()
            SendTxt( user, env, Bot.name, "the category " .. what1 .. " was successfully added." )
        else
            if FreshStuff.Types[ what1 ] == what2 then
                SendTxt( user, env, Bot.name, "the category " .. what1 .. " exists." )
            else
                FreshStuff.Types[ what1 ] = what2
                FreshStuff.SaveCt()
                SendTxt( user, env, Bot.name, "the category " .. what1 .. " was successfully changed." )
            end
        end
    else
...
function FreshStuff.DelCatgry( user, data, env)
    ...
    if what then
        if not FreshStuff.Types[ what ] then
            SendTxt( user, env, Bot.name, "the category " .. what .. " doesnt exists." )
        else
            FreshStuff.Types[ what ] = nil
            FreshStuff.SaveCt()
            SendTxt( user, env, Bot.name, "the category " .. what .. " was successfully deleted." )
        end
    else
...
function FreshStuff.PruneRel( user, data, env )
    ...
    local cnt = 0
    local x = os.clock()
    hub.broadcast( "startet Release-Delete-Process, all Releases older than " .. days .. " days was deleted from database.", Bot.name )
    ...
    hub.broadcast( FreshStuff.Count .. " releases searched and " .. cnt .. " deleted.", Bot.name )
    if cnt ~= 0 then
        FreshStuff.SaveRel()
        FreshStuff.ReloadRel()
    end
...
function FreshStuff.ShowTopAdders( user, data, env )
    local tmp, numtbl, msg = {}, {}, "\nDie Top " .. FreshStuff.TopAddersCount .. " Releasers are:\n" .. string.rep( "-", 33 ) .. "\n"
