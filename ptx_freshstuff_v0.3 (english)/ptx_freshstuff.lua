...
local ucmd_add = "add"
local ucmd_show = "show"
local ucmd_show_newest_01 = "Show "
local ucmd_show_newest_02 = " newest releases"
local ucmd_show_top_releaser = "Show Top Releasers"
local ucmd_search_release = "Search a Release"
local ucmd_delete_release = "Delete a Release"
local ucmd_reload_db = "Reload database"
local ucmd_prune_01 = "Delete older Releases"
local ucmd_prune_02 = "Max. Age in Days (empty=defaults to "

local msg_error_01 = "The category file is corrupt or missing."
local msg_error_02 = "The releases file is corrupt or missing."
local msg_error_03 = "Command incomplete."

local msg_denied = "You are not allowed to use this command."
local msg_disabled = "This command is disabled."

local msg_empty_db = "There are no Releases in the database."
local msg_missing_cat = "No such type."

local msg_add_crap_01 = "Dollar chars ($) in releasenames not allowed."
local msg_add_crap_02 = "There are an other release with this name in the category: "
local msg_add_crap_03 = " was added as: "
local msg_add_crap_04 = " added to the category ["
local msg_add_crap_05 = "] the following Release: "
local msg_add_crap_06 = "Unkonwn category: "
local msg_add_crap_07 = "I dont know what you are mean :)"

local msg_del_crap_01 = " was deleted."
local msg_del_crap_02 = "Release with number ["
local msg_del_crap_03 = "] was deleted from database."
local msg_del_crap_04 = "Amount of deleted releases: "
local msg_del_crap_05 = "   |   Attended time in seconds: "

local msg_reload_rel_01 = "Releases reloaded, attended time in seconds: "
...
local msg_search_rel_02 = "Your search string was not found in the database."

local msg_showrel_01 = "No Releases in database found."
local msg_showrel_02 = "by: "
local msg_showrel_03 = "No: "
