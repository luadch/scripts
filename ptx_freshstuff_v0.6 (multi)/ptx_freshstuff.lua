--[[
    ...
    ptx_freshstuff.lua converted by blastbeat
        ...
        v0.6: by pulsar
            - fixing bug in TopAdders count  / thx Kungen
        
        v0.5: by pulsar
            - adding "when" and "who" to the release search results  / request by lykil
    ...
    if what then
        ...
        if table_getn( rest ) ~= 0 then
            for i = 1, table_getn( rest ) do
                ...
                res = res + 1
                msg = msg .. msg_showrel_03 .. i .. "  \t|   " .. when .. "   |   " .. title .. "   |   " .. msg_showrel_02 .. who .. "\n"
            end
